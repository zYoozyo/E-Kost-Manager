            ...
            <div className="flex justify-between items-center py-3 sm:py-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
                ...
                <button
                  ...
                  className="bg-navy-900 text-white px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg hover:bg-navy-800 transition-colors text-xs sm:text-sm whitespace-nowrap"
                >
